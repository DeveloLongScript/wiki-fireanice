...
<Alert title="This will NOT be reverted" description="For any point of this wiki being out, this will not be reverted. This will never be something planned to be reverted, and doesn't matter on how much the staff annoy me." variant="important"/>
...
## Unoffical(ish)
This wiki *was made without any resources from FireAnIceBox*, however was coded and wrote at its base from a *Developer on the team (aka Giftedly)*.
