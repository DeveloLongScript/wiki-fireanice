...
## Creating a new file
Starting a new file can be easy, however you need to categorize and make sure the headings are the correct style and have the right functions. To start a file, you need the following things at the top and bottom.<br/>
<Alert title="Stop!" description="This functionality has been deprecated in v0.6.0. You do not need to do this anymore, by default the layout includes the Layout in MDX. (for some reason, it wasn't working prior to v0.6.0, which means it had to be added manually)" variant="destructive"/>
**Top**:
```ts
{/* DO NOT TOUCH THIS */}
